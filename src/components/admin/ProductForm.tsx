...
import { 
  X, Plus, Upload, Loader2, ChevronDown, ChevronUp, Trash2 
} from 'lucide-react';
    ...
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="w-full grid grid-cols-4 h-10">
          ...
          <TabsTrigger value="specs">商品属性</TabsTrigger>
          <TabsTrigger value="variants">规格变体</TabsTrigger>
        </TabsList>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-neutral-200 rounded-lg min-h-[120px] resize-none"
                placeholder="请输入商品描述"
              />
            </div>
