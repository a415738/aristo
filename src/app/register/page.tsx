    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 xl:px-24">
          ...
          <div className="mb-16">
            ...
            <p className="text-white/50 leading-relaxed max-w-sm text-sm">
              注册成为会员，享受专属优惠和个性化服务，开启专属于你的美妆之旅。
            </p>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 bg-white">
        <div className="w-full max-w-sm">
          ...
          {/* 标题 */}
          <div className="mb-8">
            <h2 className="text-2xl font-medium text-neutral-900 mb-2">注册</h2>
            <p className="text-sm text-neutral-500">创建账户开始购物</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <label htmlFor="name" className="text-xs font-medium text-neutral-600 uppercase tracking-wider">
                姓名
              </label>
            ...
            {/* 确认密码 */}
            <div className="space-y-2">
              <label htmlFor="confirmPassword" className="text-xs font-medium text-neutral-600 uppercase tracking-wider">
                确认密码
              </label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-neutral-400" />
            ...
            <div className="flex items-start gap-2 pt-2">
              ...
              />
              <label htmlFor="agree" className="text-sm text-neutral-600 leading-relaxed">
                我已阅读并同意{' '}
